...
export async function seedDatabase() {
  ...
  await storage.createDevice({ macAddress: "AA:BB:CC:DD:EE:01", imei: "123456789012345", operatorId: o1.id, operatorName: "Rajesh Kumar", centerName: "Delhi Public School", centreCode: "DEL001", examId: exam1.id, examName: "UPSC Civil Services 2024", model: "Samsung Tab A7", androidVersion: "12", batteryLevel: 85, lastSyncAt: "25/01/2024, 03:55 pm", mdmStatus: "Active", loginStatus: "Logged In", status: "Active" });
  await storage.createDevice({ macAddress: "AA:BB:CC:DD:EE:02", imei: "123456789012346", operatorId: o2.id, operatorName: "Priya Sharma", centerName: "Delhi Public School", centreCode: "DEL001", examId: exam1.id, examName: "UPSC Civil Services 2024", model: "Lenovo Tab M10", androidVersion: "11", batteryLevel: 72, lastSyncAt: "25/01/2024, 03:50 pm", mdmStatus: "Active", loginStatus: "Logged In", status: "Active" });
  await storage.createDevice({ macAddress: "AA:BB:CC:DD:EE:03", imei: "123456789012347", operatorId: o3.id, operatorName: "Amit Patel", centerName: "Kendriya Vidyalaya", centreCode: "DEL002", examId: exam1.id, examName: "UPSC Civil Services 2024", model: "Samsung Tab A8", androidVersion: "13", batteryLevel: 45, lastSyncAt: "25/01/2024, 03:30 pm", mdmStatus: "Active", loginStatus: "Logged In", status: "Active" });
  await storage.createDevice({ macAddress: "AA:BB:CC:DD:EE:04", imei: "123456789012348", operatorId: o4.id, operatorName: "Sneha Reddy", centerName: "St. Xaviers College", centreCode: "MUM001", examId: exam1.id, examName: "UPSC Civil Services 2024", model: "Realme Pad", androidVersion: "11", batteryLevel: 92, lastSyncAt: "25/01/2024, 03:45 pm", mdmStatus: "Inactive", loginStatus: "Logged Out", status: "Active" });
  await storage.createDevice({ macAddress: "AA:BB:CC:DD:EE:05", imei: "123456789012349", operatorId: o5.id, operatorName: "Vikram Singh", centerName: "IIT Bombay Hall", centreCode: "MUM002", examId: exam1.id, examName: "UPSC Civil Services 2024", model: "Samsung Tab S6 Lite", androidVersion: "12", batteryLevel: 68, lastSyncAt: "25/01/2024, 03:40 pm", mdmStatus: "Active", loginStatus: "Logged In", status: "Active" });
